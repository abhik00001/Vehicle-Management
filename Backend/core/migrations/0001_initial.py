    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.CharField(choices=[('LTV', 'LTV'), ('HTV', 'HTV')], max_length=20)),
                ('vehicle_photos', models.ImageField(blank=True, null=True, upload_to='vehicle_img')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('driver', 'Driver')], default='admin', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_assigned', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.vehicle')),
            ],
        ),
    ]
